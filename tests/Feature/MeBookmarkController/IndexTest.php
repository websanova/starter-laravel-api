...
test('user can list their bookmarks', function () {
    ...
    $response = $this->actingAs($user)->getJson('/me/bookmarks');
...
test('user can filter bookmarks by category', function () {
    ...
    $response = $this->actingAs($user)->getJson("/me/bookmarks?category_id={$category->id}");
...
test('user can filter uncategorized bookmarks', function () {
    ...
    $response = $this->actingAs($user)->getJson('/me/bookmarks?category_id=0');
...
test('can set per page limit', function () {
    ...
    $response = $this->actingAs($user)->getJson('/me/bookmarks?per_page=2');
...
test('unauthenticated user cannot list bookmarks', function () {
    $response = $this->getJson('/me/bookmarks');
