...
test('user can list their notifications', function () {
    ...
    $response = $this->actingAs($user)->getJson('/account/notifications');
...
test('user can filter read notifications', function () {
    ...
    $response = $this->actingAs($user)->getJson('/account/notifications?read=1');
...
test('user can filter unread notifications', function () {
    ...
    $response = $this->actingAs($user)->getJson('/account/notifications?read=0');
...
test('can set per page limit', function () {
    ...
    $response = $this->actingAs($user)->getJson('/account/notifications?per_page=2');
...
test('invalid read filter returns validation error', function () {
    ...
    $response = $this->actingAs($user)->getJson('/account/notifications?read=invalid');
...
test('unauthenticated user cannot list notifications', function () {
    $response = $this->getJson('/account/notifications');
