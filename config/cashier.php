...
return [
    ...
    */
    ...
    |
    | NOTE: The events list adds to Cashier's defaults. cashier:webhook only
    | creates, it never updates, so it is an init step only. Once an endpoint
    | exists, either delete it and run the command again, or edit its events by
