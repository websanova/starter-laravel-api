...
- Default behavior is DESCRIBE ONLY. Show what would change, show the code, show the diff - but never write to disk. The go-ahead phrase is the ONLY trigger that authorizes a file write or edit.
